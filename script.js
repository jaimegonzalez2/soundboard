document.addEventListener("DOMContentLoaded", function() {
    ...
    const sounds = {
        ...
        sound20: { file: new Audio('sounds/my_leg.mp3'), label: 'My Leg', category: 'audio-clips' },
        sound21: { file: new Audio('sounds/the_holy_grail_runaway.mp3'), label: 'Holy Grail Runaway', category: 'audio-clips' },
        sound22: { file: new Audio('sounds/I_see_dead_people.mp3'), label: 'I See Dead People', category: 'audio-clips' },
        sound23: { file: new Audio('sounds/your_one_warning.mp3'), label: 'Your One Warning', category: 'audio-clips' },
