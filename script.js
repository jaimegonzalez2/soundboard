document.addEventListener("DOMContentLoaded", function() {
    ...
    const sounds = {
        ...
        // 🔊 Audio Clips
        sound18: { file: new Audio('sounds/Im_a_fireball.mp3'), label: 'Fireball', category: 'audio-clips' },
        sound19: { file: new Audio('sounds/simpsons.mp3'), label: 'I\'m In Danger', category: 'audio-clips' },
        sound20: { file: new Audio('sounds/Kamehameha.mp3'), label: 'Kamehameha', category: 'audio-clips' },
        sound21: { file: new Audio('sounds/workaholics.mp3'), label: 'I Almost Died', category: 'audio-clips' },
        sound22: { file: new Audio('sounds/but_did_you_die.mp3'), label: 'But Did You Die?', category: 'audio-clips' },
        sound23: { file: new Audio('sounds/Alakablam.mp3'), label: 'Alakablam', category: 'audio-clips' },
        sound24: { file: new Audio('sounds/The_Waco_Kid.mp3'), label: 'Shot Me In The Ass', category: 'audio-clips' },
        sound25: { file: new Audio('sounds/sydney_doing_math.mp3'), label: 'Sydney Doing Math', category: 'audio-clips' },
        sound26: { file: new Audio('sounds/my_leg.mp3'), label: 'My Leg', category: 'audio-clips' },
        sound27: { file: new Audio('sounds/the_holy_grail_runaway.mp3'), label: 'Holy Grail Runaway', category: 'audio-clips' },
        sound28: { file: new Audio('sounds/I_see_dead_people.mp3'), label: 'I See Dead People', category: 'audio-clips' },
        sound29: { file: new Audio('sounds/your_one_warning.mp3'), label: 'Your One Warning', category: 'audio-clips' },
        sound30: { file: new Audio('sounds/suspicious.mp3'), label: 'Don\'t Be Suspicious', category: 'audio-clips' },
        sound31: { file: new Audio('sounds/LastTime_DragonBallZsound.mp3'), label: 'Dragonball Z', category: 'audio-clips' },
        sound32: { file: new Audio('sounds/roxSound.mp3'), label: 'ROX', category: 'audio-clips' },
        sound33: { file: new Audio('sounds/YameteKudasai.mp3'), label: 'Yamete Kudasai (18+)', category: 'audio-clips' },
        sound34: { file: new Audio('sounds/uwuSound.mp3'), label: 'UWU', category: 'audio-clips' },
        sound35: { file: new Audio('sounds/Dora.mp3'), label: 'We Did It!', category: 'audio-clips' },
        sound36: { file: new Audio('sounds/NotPrepared.mp3'), label: 'You Are Not Prepared', category: 'audio-clips' },
        sound37: { file: new Audio('sounds/Lizard.mp3'), label: 'Lizard', category: 'audio-clips' },
        sound38: { file: new Audio('sounds/TuskenRaider.mp3'), label: 'Tusken Raider', category: 'audio-clips' }
    };
