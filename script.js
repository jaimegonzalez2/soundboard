document.addEventListener("DOMContentLoaded", function() {
    ...
    const sounds = {
        ...
        sound1: { file: new Audio('sounds/my_leg.mp3'), label: 'My Leg', category: 'sound-effects' },
        sound2: { file: new Audio('sounds/simpsons.mp3'), label: 'I\'m In Danger', category: 'sound-effects' },
        ...
        sound6: { file: new Audio('sounds/the_holy_grail_runaway.mp3'), label: 'Holy Grail Runaway', category: 'sound-effects' },
        ...
        sound9: { file: new Audio('sounds/your_one_warning.mp3'), label: 'Your One Warning', category: 'sound-effects' },
        ...
        sound16: { file: new Audio('sounds/Air_Raid_Siren.mp3'), label: 'Air Raid Siren', category: 'audio-clips' },
        ...
        sound20: { file: new Audio('sounds/Gunshot.mp3'), label: 'Gunshot', category: 'audio-clips' },
        sound21: { file: new Audio('sounds/KABOOM.mp3'), label: 'Explosion', category: 'audio-clips' },
        sound22: { file: new Audio('sounds/I_see_dead_people.mp3'), label: 'I See Dead People', category: 'audio-clips' },
        sound23: { file: new Audio('sounds/spell_casting.mp3'), label: 'Spell Casting', category: 'audio-clips' },
        sound24: { file: new Audio('sounds/suspicious.mp3'), label: 'Don\'t Be Suspicious', category: 'audio-clips' }
    };
